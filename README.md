...
The reader supports two playback modes: **continuous playback mode** and **repeating playback mode**. The repeating playback mode gives learners time to repeat each sentence before moving on to the next one. Clicking a transcript sentence jumps directly to that point in the video.
