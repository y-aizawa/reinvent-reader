...
The reader supports two playback modes: **continuous playback** and **playback with pauses between sentences**. Clicking a transcript sentence jumps directly to that point in the video.
