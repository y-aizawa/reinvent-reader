...
The reader supports two playback modes: **continuous playback** and **repeating playback**. The repeating playback gives learners time to repeat each sentence before moving on to the next one. Clicking a transcript sentence jumps directly to that point in the video.
